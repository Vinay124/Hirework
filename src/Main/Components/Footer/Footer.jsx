    ...
    <footer className='Footer'>
      <Container>
        ...
        <Row className='footerMainRow'>
          <Col className="col-lg-4 col-md-12 col-sm-12 footerMainRowCol">
            <div>
          ...
          <Col className="col-lg-2 col-md-3 col-sm-6 text-center quickLinksCol">
          ...
          <Col className="col-lg-2 col-md-3 col-sm-6 text-center ForCandidatesCol">
            <div className='footerinnerTxt'>
          ...
          <Col className="col-lg-2 col-md-3 col-sm-6 text-center ForEmployersCol">
            <div className='footerinnerTxt'>
              <h6>For Employers</h6>
            </div>
          ...
          <Col className="col-lg-2 col-md-3 col-sm-6 text-center downloadAppCol">
            <div className='footerinnerTxt'>
              <h6>Download App</h6>
            </div>
